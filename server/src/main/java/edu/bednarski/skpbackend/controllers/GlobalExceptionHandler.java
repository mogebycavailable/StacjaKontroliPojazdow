...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<?> handleDataNotProvidedException(final DataNotProvidedException ex) {
        return new ResponseEntity<>(ex.getMessage(), HttpStatus.BAD_REQUEST);
    }
    ...
    @ExceptionHandler(DuplicateStandNameException.class)
    public ResponseEntity<?> handleDuplicateStandNameException(final DuplicateStandNameException ex) {
        return new ResponseEntity<>(ex.getMessage(), HttpStatus.BAD_REQUEST);
    }

    @ExceptionHandler(WeekDayNotFoundException.class)
    public ResponseEntity<?> handleWeekDayNotFoundException(final WeekDayNotFoundException ex) {
        return new ResponseEntity<>(ex.getMessage(), HttpStatus.BAD_REQUEST);
    }
