...
public class UserDetailsDto {
    ...
    public boolean equals(final Object o) {
        ...
        final UserDetailsDto other = (UserDetailsDto) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof UserDetailsDto;
    }
    ...
    public String toString() {
        return "UserDetailsDto(name=" + this.getName() + ", surname=" + this.getSurname() + ", email=" + this.getEmail() + ", phone=" + this.getPhone() + ")";
    }
}
